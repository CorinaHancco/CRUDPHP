...
<body>
    ...
    if (isset($_REQUEST['agregar'])) {
        ...
        //echo $descripcion;
        $consulta = " INSERT INTO presentacion(descipcion) VALUES('$descripcion')";
        //echo 'Consulta ok';
    ...
    if (isset($_REQUEST['guardarCambios'])) {
        ...
        $consulta = "UPDATE presentacion SET descipcion='$descripcion' WHERE id='$id' ";
    ...
    if (isset($_REQUEST['confirmarEliminacion'])) {
        ...
        $consulta = "DELETE FROM presentacion WHERE id='$id' ";
        // echo 'ok';
